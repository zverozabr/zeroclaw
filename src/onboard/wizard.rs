...
fn default_model_for_provider(provider: &str) -> String {
    ...
    match canonical_provider_name(provider) {
        ...
        "sglang" | "vllm" | "osaurus" | "copilot" | "opencode-go" => "default".into(),
...
async fn scaffold_workspace(
    ...
    if identity_config.format == "aieos" {
        let default_path = default_aieos_identity_path();
...
mod tests {
    ...
    async fn scaffold_creates_default_aieos_identity_file_when_selected() {
        ...
        assert_eq!(payload["identity"]["user"]["preferred_name"], "Argenis");
    }
    ...
    fn backend_key_from_choice_maps_supported_backends() {
        // Current selectable backends: sqlite, lucid, markdown, none
        ...
        assert_eq!(backend_key_from_choice(999), "sqlite"); // out of bounds defaults to sqlite
    }
    ...
    // sqlite_qdrant_hybrid backend was removed during merge cleanup
    // #[test]
