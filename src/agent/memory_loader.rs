use crate::memory::{self, retrieval, Memory, MemoryCategory};
...
impl MemoryLoader for DefaultMemoryLoader {
    async fn load_context(
        ...
        let entries_result: Result<Vec<crate::memory::traits::MemoryEntry>, _> =
        ...
        // TODO: decay module removed, re-enable when available
